...
// import "../styles/conditions.module.css"
  ...
  return (
    <div>
      <p>
        ...
        Artificial (IA) para la lectura y procesamiento de archivos. Al utilizar
        nuestros servicios, aceptas estar de acuerdo con los términos y
        condiciones detallados a continuación.
      </p>

      <h2>1. Permisos y Consentimiento del Usuario</h2>
      <p>
        El usuario debe otorgar consentimiento explícito antes de que cualquier
        archivo sea procesado por nuestra IA. Al subir un archivo, el usuario
        garantiza que tiene los derechos y permisos necesarios para que dicho
        archivo sea procesado.
      </p>
      <p>
        No recopilamos ni procesamos archivos sin el consentimiento del usuario,
        y este tiene la libertad de retirar su consentimiento en cualquier
        momento, excepto en los casos donde el procesamiento ya se haya
        completado.
      </p>
      ...
      <p>
        Nos comprometemos a proteger la privacidad de los archivos subidos. Toda
        la información procesada a través de nuestra IA está sujeta a estrictas
        medidas de seguridad, incluyendo el uso de cifrado en tránsito y en
        reposo.
      </p>
      <p>
      ...
      <p>
        Cumplimos con las normativas de protección de datos vigentes, incluyendo
        el Reglamento General de Protección de Datos (GDPR) en Europa y la Ley
        de Privacidad del Consumidor de California (CCPA). Esto implica que el
        usuario tiene derecho a acceder, modificar o eliminar los archivos que
        ha subido, y tiene derecho a saber cómo se están procesando sus datos.
      </p>

      <h2>5. Uso Ético y Responsable</h2>
      <p>
        El usuario se compromete a no subir archivos que contengan material
        ilegal, difamatorio, fraudulento, malicioso, o que infrinja los derechos
        de propiedad intelectual de terceros. El uso de nuestra IA para procesar
        este tipo de archivos está estrictamente prohibido y puede resultar en
      ...
      <p>
        No seremos responsables de cualquier daño directo, indirecto, incidental
        o consecuente que resulte del uso de nuestra IA, incluyendo pero no
        limitándose a, la pérdida de archivos, la pérdida de ingresos o el daño
        a la reputación.
      </p>
      <p>
        El uso de nuestra IA es bajo el riesgo exclusivo del usuario. Proveemos
        el servicio "tal como está" y no garantizamos la precisión,
        disponibilidad ni resultados específicos derivados del uso de la IA.
      </p>

      <h2>8. Terminación del Servicio</h2>
      <p>
        Nos reservamos el derecho de terminar o suspender el acceso a nuestra IA
        en cualquier momento, sin previo aviso, si determinamos que se han
      ...
      <h2>10. Contacto</h2>
      <p>
        Si tienes alguna pregunta sobre estos términos y condiciones o sobre el
        uso de nuestra IA, puedes ponerte en contacto con nosotros a través de
